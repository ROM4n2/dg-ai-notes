...
![Session Tree：append-only 的状态变化](assets/260702-ch10-session-tree.svg)
...
![Session Tree 上的 9 种 Entry 类型](assets/260702-ch10-entry-taxonomy.svg)
...
> **写给有幸读完的读者**：请继续阅读[实战上手篇](../../pi_sdk_learn/docs/第1章-环境部署-10分钟跑通第一个Agent.md)。它用 7 章篇幅，带你把 Pi 当作 SDK 真正用起来——从环境部署、模型配置、自定义工具，一路到封装成服务上线（附 TS 与 Python 代码对照，会 Python 也能读懂全部示例）。看懂了源码，上手会快得多。
